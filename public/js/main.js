...
},{"./VuetablePaginationMixin.vue":33,"vue":27,"vue-hot-reload-api":2}],31:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "D:\\www\\projects\\vuetable.web\\node_modules\\vuetable\\src\\components\\VuetablePaginationBootstrap.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"./VuetablePaginationMixin.vue":33,"vue":27,"vue-hot-reload-api":2}],32:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "D:\\www\\projects\\vuetable.web\\node_modules\\vuetable\\src\\components\\VuetablePaginationDropdown.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"./VuetablePaginationMixin.vue":33,"vue":27,"vue-hot-reload-api":2}],33:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    events: {
        ...
        'vuetable-pagination:setting': function vuetablePaginationSetting(option, value) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "D:\\www\\projects\\vuetable.web\\node_modules\\vuetable\\src\\components\\VuetablePaginationMixin.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
new Vue({
    ...
    data: {
        ...
        itemActions: [{ name: 'view-item', label: '', icon: 'glyphicon glyphicon-zoom-in', class: 'btn btn-info' }, { name: 'edit-item', label: '', icon: 'glyphicon glyphicon-pencil', class: 'btn btn-warning' }, { name: 'delete-item', label: '', icon: 'glyphicon glyphicon-remove', class: 'btn btn-danger' }],
        moreParams: []
    },
    watch: {
...
},{"vue":27,"vue-resource":16,"vuetable/src/components/Vuetable.vue":29,"vuetable/src/components/VuetablePagination.vue":30,"vuetable/src/components/VuetablePaginationBootstrap.vue":31,"vuetable/src/components/VuetablePaginationDropdown.vue":32}]},{},[34]);
